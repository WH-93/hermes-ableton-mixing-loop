...
@register("get_all_track_names")
def get_all_track_names(song, params):
    """Return track names, mute states, and basic info for all tracks.
    Lightweight — no clip slots, no device parameters. ~10x faster than
    calling get_track_info for each track individually."""
    tracks = []
